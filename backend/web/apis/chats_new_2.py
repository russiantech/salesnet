    ...
    try:
        ...
        if recipient_username:
            ...
            if not group:
                ...
                # group_name = 'rm_edet_edet_group'
                # group_description = 'A chat group between edet and edet'
                # is_private = 0
                # group_type = 'one_on_one'
                # group = get_or_create_group(group_name, group_description, is_private, group_type)
